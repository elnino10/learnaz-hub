...
function Footer() {
  ...
  return (
    <footer className="mt-32 bg-gray-800">
      <div className="pt-2 max-w-screen-xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          <p className="text-gray-300">
            © {new Date().getFullYear()} LearnazHub All rights reserved.
          </p>
