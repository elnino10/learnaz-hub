...
function CoursePreviewPage(props) {
  ...
  return (
    <>
      <div
        className="w-[53rem] mt-16 min-h-screen relative max-w-7xl bg-background
      text-foreground sm:w-[51.5rem] sm:mt-20 md:w-full md:mt-[6rem]"
      >
        {isLoading ? (
          ...
          <div className="">
            <div
              className="relative flex flex-col px-4 items-center justify-between sm:items-start
            bg-gray-800 text-white md:flex-row lg:items-center"
            >
              ...
              <div
                className="w-[25rem] bg-white text-gray-800 pt-3 px-3 rounded-md shadow-lg
              mt-8 sm:w-[20rem] sm:absolute sm:translate-x-[29rem] sm:translate-y-[1rem] md:mt-5
              md:w-[25rem] md:max-h-[22rem] md:ml-[48rem] md:translate-x-16 md:translate-y-[-1rem]
              lg:w-1/3 lg:mt-0"
              >
                <img
                ...
                <button
                  ...
                  className="bg-gray-800 text-white font-bold border border-primary text-primary
                  w-full py-1 rounded hover:bg-primary/10"
                >
                  Enroll
                </button>
                <p className={`${TEXT_MUTED_FOREGROUND} text-center mt-2`}></p>
              </div>
            </div>
